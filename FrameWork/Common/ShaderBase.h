...
public:
    ...
    virtual bool AddShaderFromSourceCode(ShaderBase::ShaderType type, const char *source) { return true; }
    virtual bool AddShaderFromFilePath(ShaderBase::ShaderType type, const char *path) { return true; }
