...
void RenderText(GameEngine::Shader &shader, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color);
...
int main()
{
    ...
    // --------------------
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "CPPGame", NULL, NULL);
    if (window == NULL)
    {
