...
int GameEngine::WindowsApplication::Initialize()
{
    int result;
...
void GameEngine::WindowsApplication::Finalize()
{
}

void GameEngine::WindowsApplication::Tick()
{
...
LRESULT CALLBACK GameEngine::WindowsApplication::WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
